...
contract BananaToken is ERC20, Owned {
    ...
    function internalTransfer(
        ...
        balanceOf[toaddr] = balanceOf[toaddr].add(value); //safeAdd(balanceOf[toaddr], value); emit Transfer(from, toaddr, value);
    }
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        uint256 transBlalance = balanceOf[msg.sender].sub(
            lockValues[msg.sender]
        );
