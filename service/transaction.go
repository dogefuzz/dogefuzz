...
type TransactionService interface {
	...
	FindByTaskId(taskId string) []*dto.TransactionDTO
...
func (s *transactionService) FindByTaskId(taskId string) []*dto.TransactionDTO {
	// TODO: return list of transaction related to task
	return nil
}
